...
//**************Secure********* */
function empecherClicDroit(e) {
    e.preventDefault();
}
// Attacher l'événement contextmenu au document
document.addEventListener('contextmenu', empecherClicDroit);
//*********Secure*********** */
function empecherToucheF12(e) {
    if (e.key === "F12") {
        e.preventDefault();
   }
}
// Attacher l'événement keydown au document
document.addEventListener('keydown', empecherToucheF12);
